...
namespace WingCommand
{
    ...
    internal sealed class WmcOrdersTab : IWmcTab
    {
        ...
        {
            card = AvStyled.Label(page, new Rect(body.x, body.y, body.width, 22f), "", "row-name");
            float y = body.y - 22f - WmcUi.Gap;
            y = WmcUi.Title(page, body, y, "TASK");
            ...
            y = WmcUi.Title(page, body, y, "COMBAT");
            y = WmcUi.Buttons(page, body, y, 3, ids,
            ...
            y = WmcUi.Title(page, body, y, "HELO");
