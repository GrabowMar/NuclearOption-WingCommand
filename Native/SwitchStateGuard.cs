...
namespace WingCommand
{
    ...
    /// blocked ejection) becomes our flight again, re-approaching. A dead pilot is never redirected.</summary>
    ...
    internal static class SwitchStateGuard
    {
        ...
        private static void Prefix(Pilot __instance, ref PilotBaseState state)
        {
            ...
            PilotBaseState ours = wing.LeaveNativeLanding(__instance, state);
