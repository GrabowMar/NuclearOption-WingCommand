...
namespace WingCommand
{
    ...
    internal static class Tuning
    {
        public static readonly Type[] Types =
        {
            ...
            typeof(StuckWatchdog), typeof(GroundPilot), typeof(FieldTraffic), typeof(ServiceSpots), typeof(RecoveryPilot), typeof(PilotSkill), typeof(RefitTimer), typeof(BingoMonitor), typeof(TaskLead), typeof(WingPlanner), typeof(CombatSupervisor), typeof(TargetAllocator), typeof(OutnumberedJudge), typeof(TargetSpread), typeof(WingHudText), typeof(MissileDefence), typeof(StandingFire), typeof(CommandValidator), typeof(SettlePilot), typeof(WingMirror), typeof(ClearSix), typeof(RadioQueue), typeof(Bra), typeof(ContactWatch), typeof(SettleJob), typeof(PerkEffects), typeof(ApSteps), typeof(OrderValidator), typeof(NavFollower), typeof(DamageWatch), typeof(EjectRules), typeof(RadarDiscipline), typeof(ReactionManeuver), typeof(ShopRules),
        };
