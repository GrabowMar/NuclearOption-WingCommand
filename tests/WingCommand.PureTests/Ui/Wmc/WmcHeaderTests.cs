...
namespace WingCommand.PureTests
{
    public class WmcHeaderTests
    {
        ...
        public void ChipsSayTheirStateInWords()
        {
            ...
            Assert.Equal("RESV 1/3", WmcHeader.Reserve(1, 3, false, out string r1)); Assert.Equal("info", r1);
            Assert.Equal("RESV —", WmcHeader.Reserve(0, 3, true, out string r2)); Assert.Equal("inert", r2);
